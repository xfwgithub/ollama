...
/*
#cgo CFLAGS: -O3 -std=c11 -DGGML_BUILD=1 -DNDEBUG -DLOG_DISABLE_LOGS -DGGML_USE_LLAMAFILE -DGGML_USE_CPU -DGGML_USE_CPU_AARCH64
#cgo CXXFLAGS: -O3 -std=c++11 -DGGML_BUILD=1 -DNDEBUG -DLOG_DISABLE_LOGS -DGGML_USE_LLAMAFILE -DGGML_USE_CPU -DGGML_USE_CPU_AARCH64
...
#cgo linux,rocm LDFLAGS: -L/opt/rocm/lib -lpthread -lrt -lresolv
...
void llamaLog(int level, char* text, void* user_data);
